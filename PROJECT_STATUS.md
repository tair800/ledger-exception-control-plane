...
**Next:** 6.2 — the CI evaluation gate, proven to fail by injecting a regression. 6.1 is done: a
committed golden set of 250 labelled exceptions and a scorer that cannot be flattered by class
imbalance. Then 6.3's three-arm comparison, M7's console, M8's observability, M9's orchestration and
M10's deployment. See
...
| 6.2 – 12.1 | NOT STARTED | See `IMPLEMENTATION_PLAN.md` (31 increments total) |

...
| **Human-labelled hold-out slice** | **PENDING OWNER LABEL REVIEW** | 25 records reviewed. The slice is frozen and hashed, the packet is generated, the importer validates it, and every record still says `label_source: derived`. A test asserts that. **OPEN-15.** |
